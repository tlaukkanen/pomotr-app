...
namespace PomotrApp.IdentityServer
{
...
#pragma warning restore SecurityIntelliSenseCS // MS Security rules violation
        ...
        public async Task<IEnumerable<SecurityKeyInfo>> GetValidationKeysAsync()
        {
            ...
            foreach (var certificateItem in enabledCertificateVersions)
            {
                ...
                validationKeys.Add(
                    new SecurityKeyInfo
                    {
                        Key = await GetSecurityKeyFromCertificateAsync(certificateItem),
    ...
    public abstract class KeyStore
    {
        ...
        {
            var certificateVersionSecurityKeyInfo = await GetSecurityKeyFromCertificateAsync(certificateItem);
            return new SigningCredentials(certificateVersionSecurityKeyInfo, SecurityAlgorithms.RsaSha256);
        }
